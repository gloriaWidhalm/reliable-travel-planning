...
def get_paths(departure_station: str, arrival_station: str, departure_time: int):
    ...
    shortest_path_reliability = compute_reliability(shortest_path_result, departure_time, (shortest_time - departure_time) * 1, transfer_time=5)
    ...
    difference = most_reliable_path_result[-1]["planned_arrival"] - shortest_path_result[-1]["planned_arrival"]
...
def index():
    if request.method == "POST":
        ...
        (shortest_path, shortest_path_reliability,
